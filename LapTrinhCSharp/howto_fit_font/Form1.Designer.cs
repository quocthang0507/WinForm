namespace howto_fit_font
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox1.Text = "Xin chào các bạn";
			...
			// autoResizeLabel1
			// 
			this.autoResizeLabel1.Font = new System.Drawing.Font("Microsoft Sans Serif", 54F);
			this.autoResizeLabel1.font_size = 54;
			this.autoResizeLabel1.ForeColor = System.Drawing.Color.Red;
			this.autoResizeLabel1.Location = new System.Drawing.Point(12, 118);
			...
			this.autoResizeLabel1.Text = "Xin chào các bạn";
			// 
			// Form1
			// 
			...
			this.Name = "Form1";
			this.Text = "Create Component AutoResize Label";
